...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#e5e5e5] font-sans antialiased flex flex-col justify-between selection:bg-[#f59e0b] selection:text-black">
      <Header
      ...
      <main className="flex-1 max-w-md w-full mx-auto px-3 pt-3 pb-24 flex flex-col space-y-3 overflow-x-hidden">
        {errorMessage && (
          <div className="p-3 bg-[#450a0a]/90 border border-[#ef4444] rounded-lg text-rose-200 text-xs flex items-start gap-2 shadow-md animate-in fade-in duration-200">
            <AlertTriangle className="w-4 h-4 text-[#ef4444] shrink-0 mt-0.5" />
            <div className="flex-1 leading-snug font-mono">
              <span className="font-bold tracking-wide uppercase block text-[10px] text-rose-300">
                SYSTEM INTERRUPT
              </span>
        ...
        {statusMessage && (
          <div className="p-2.5 bg-[#052e16]/90 border border-[#22c55e] rounded-lg text-[#22c55e] text-xs flex items-center gap-2 shadow-md font-mono animate-in fade-in duration-200">
        ...
        {!firebaseConnected && (
          <div className="p-2 bg-[#121212] border border-[#f59e0b]/40 rounded-lg text-xs flex items-center justify-between text-[#f59e0b] font-mono">
        ...
        {activeTab === "scan" && (
          <SearchTab
            ...
            setAskingPriceInput={setAskingPriceInput}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#000000]/95 backdrop-blur-md border-t border-[#262626] max-w-md mx-auto">
