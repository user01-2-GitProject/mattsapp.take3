...
interface VaultTabProps {
  ...
  onToggleWatchlist: (cardId: string, currentVal: boolean, e: any) => void;
  onDeleteCard: (cardId: string, e: any) => void;
...
export const VaultTab: React.FC<VaultTabProps> = ({
  ...
  return (
    <div className="space-y-3.5 animate-in fade-in duration-200">
      <div className="bg-[#121212] border border-[#262626] rounded-xl p-3.5 space-y-2 shadow-xl">
        <div className="flex justify-between items-center text-[10px] font-mono text-[#737373]">
          <span>PRIVATE ENCRYPTED VAULT</span>
          <span className="text-[#22c55e] font-bold">{vaultCards.length} ASSETS REGISTERED</span>
        </div>

        <div className="flex items-baseline justify-between">
          <div>
            <div className="text-[9px] text-[#a3a3a3] font-mono uppercase">ESTIMATED PORTFOLIO VALUE</div>
          ...
          <div className="flex space-x-1.5">
            <button
              ...
              className="p-2 bg-[#171717] hover:bg-[#262626] text-white border border-[#262626] rounded-lg text-[10px] font-mono flex items-center gap-1"
              title="Export Vault as CSV"
            >
              <Download className="w-3.5 h-3.5 text-[#f59e0b]" /> CSV
            </button>
            <button
            ...
            <button
              ...
              className="p-2 bg-[#22c55e] hover:bg-[#16a34a] text-black font-bold rounded-lg text-[10px] font-mono flex items-center gap-1 shadow"
            >
      ...
      <div className="space-y-2">
        <div className="relative">
          <input
            ...
            className="w-full bg-[#121212] border border-[#262626] focus:border-[#f59e0b] rounded-lg px-3 py-2 text-xs text-white placeholder-[#525252] font-mono outline-none"
          />
          {vaultSearchQuery && (
            <button
      ...
      {vaultLoading ? (
        <div className="p-8 text-center font-mono text-xs text-[#737373] flex items-center justify-center gap-2">
        ...
        <div className="space-y-2">
          {filteredVault.map((card) => (
            <div
              ...
              className="p-3 bg-[#121212] hover:bg-[#1c1c1c] border border-[#262626] hover:border-[#f59e0b]/50 rounded-xl cursor-pointer transition-all shadow group"
            >
              <div className="flex justify-between items-start gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs text-[#a3a3a3] font-mono truncate mt-0.5">
                ...
                <div className="text-right shrink-0">
                  <div className="text-sm font-extrabold text-[#22c55e] font-mono">
                  ...
                  <div className="flex items-center justify-end space-x-1 mt-2">
                    <button
                      ...
                      className={`p-1 rounded text-xs transition-colors ${
                        card.isWatchlist ? "text-[#f59e0b]" : "text-[#737373] hover:text-white"
                      }`}
                    ...
                    <button
                      ...
                      className="p-1 text-[#737373] hover:text-[#ef4444] rounded transition-colors"
                      title="Delete Asset"
                    >
        ...
        <div className="bg-[#121212] border border-[#262626] rounded-xl p-8 text-center space-y-3 font-mono shadow-2xl">
          <div className="w-12 h-12 rounded-full bg-[#171717] text-[#737373] border border-[#262626] flex items-center justify-center mx-auto">
            <Database className="w-6 h-6" />
          </div>
          <div>
            <div className="text-sm font-bold text-white uppercase tracking-wider">NO VAULT ASSETS DETECTED</div>
